function density = garnetdensity(Mgnum, Perc_Ca, Perc_AlMgFe, P, T)
 
% calculates density of garnet
...
% physical parameters for Ca garnet (Ca)3(Al)2(Si)3(O)12
...
% physical parameters for Al, Mg, Fe garnet (Mg, Fe)3(Al)2(Si)3(O)12
par(1,2) = Mgnum*113.08 + (1-Mgnum)*115.43;         % Vo298, cm3/mole 
par(2,2) = Mgnum*179 + (1-Mgnum)*175;               % KT298, GPa
par(3,2) = 4.00;                                    % dK/dP
par(4,2) = -0.022;                                  % dK/dT
...
density = Perc_Ca*par(12,1) + Perc_AlMgFe*par(12,2);
