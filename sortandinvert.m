...
%
%
for i = 1:marker		% don't actually calculate the new compositions, but
...
Solidus = zeros(endi, 1);

rinv(1) = R-RM;
%solidus(1) = (-1.1601e-007)*(rinv(1)/1000)^3 + 0.0014*(rinv(1)/1000)^2 + -6.3821*(rinv(1)/1000) + 1.4439e+004 - 200;% melting solidus 200 degrees higher than bulk mantle
Solidus(1) = solidus(RtoP(rinv(1))) - 200;
