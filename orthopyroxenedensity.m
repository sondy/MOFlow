function density = orthopyroxenedensity(Mgnum, CaMg, P, T)
 
% calculates density of orthopyroxene
...
% at the moment calculates all pyroxenes as (Mg, Fe, Ca) solid solutions
% interpolates between Ca-bearing and non-Ca-bearing members from Bertka and Fei (1998)
