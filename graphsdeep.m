...
%         Dsolinv, rinv/1000, 'k'); 
    fig3plot = linspace(2667, 3900, 24);
    plot([2667, 3900], [3757 3757], 'r:', 'LineWidth', 2)
    %line([2667, 3900], 3757);
    plot(Dsol, r./1000, 'b--', 'LineWidth', 2)
    plot(Dsolinv, rinv./1000, 'k-.', 'LineWidth', 2); % 

    legend(...
        'Depth of Deep Dense Layer',...
        'Pre-overturn density',...
        'Post-overturn density', 'Location', 'Best')
    
    %line([2667 3900], [3757 3757]);
...
% %hold on; plot(Tsurf, [1:j]/1000); xlabel('Magma ocean surface temperature'); ylabel('Fraction solidified by volume');
